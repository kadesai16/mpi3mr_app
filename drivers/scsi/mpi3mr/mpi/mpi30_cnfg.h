...
union mpi3_allowed_cmd_scsi {
	__le16                             service_action;
	u8                                 operation_code;
	u8                                 command_flags;
};

union mpi3_allowed_cmd_ata {
	u8                                 subcommand;
	u8                                 reserved01;
	u8                                 command;
	u8                                 command_flags;
...
union mpi3_allowed_cmd {
	union mpi3_allowed_cmd_scsi           scsi;
	union mpi3_allowed_cmd_ata            ata;
	union mpi3_allowed_cmd_nvme           nvme;
};
